...
public class TopArtistsActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("Lose Yourself","Eminem","05:02",R.drawable.Lose_Yourself));
        ...
        songs.add(new Song("Capital Letters","Hailee Steinfeild","04:51",R.drawable.Capital_Letters));
